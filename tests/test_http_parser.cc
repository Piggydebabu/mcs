...
void test_request(const char *str) {
    mcs::http::HttpRequestParser parser;
    std::string tmp = str;
    ...
    if (parser.hasError()) {
        ...
        mcs::http::HttpRequest::ptr req = parser.getData();
        std::cout << req->toString() << std::endl;
    }
}

void test_response(const char *str) {
    mcs::http::HttpResponseParser parser;
    std::string tmp = str;
    ...
    if (parser.hasError()) {
        ...
        mcs::http::HttpResponse::ptr rsp = parser.getData();
