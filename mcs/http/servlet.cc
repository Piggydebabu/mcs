...
int32_t FunctionServlet::handle(mcs::http::HttpRequest::ptr request
               , mcs::http::HttpResponse::ptr response
               , mcs::http::HttpSession::ptr session) {
...
ServletDispatch::ServletDispatch()
    ...
    m_default.reset(new NotFoundServlet("mcs/1.0"));
}

int32_t ServletDispatch::handle(mcs::http::HttpRequest::ptr request
               , mcs::http::HttpResponse::ptr response
               , mcs::http::HttpSession::ptr session) {
...
int32_t NotFoundServlet::handle(mcs::http::HttpRequest::ptr request
                   , mcs::http::HttpResponse::ptr response
                   , mcs::http::HttpSession::ptr session) {
    response->setStatus(mcs::http::HttpStatus::NOT_FOUND);
    response->setHeader("Server", "mcs/1.0.0");
