...
Socket::ptr Socket::CreateUDP(mcs::Address::ptr address) {
...
bool Socket::bind(const Address::ptr addr) {
    ...
    if (uaddr) {
        ...
        if (sock->connect(uaddr)) {
            ...
            mcs::FSUtil::Unlink(uaddr->getPath(), true);
        }
    }
...
bool Socket::cancelRead() {
    return IOManager::GetThis()->cancelEvent(m_sock, mcs::IOManager::READ);
}

bool Socket::cancelWrite() {
    return IOManager::GetThis()->cancelEvent(m_sock, mcs::IOManager::WRITE);
}
